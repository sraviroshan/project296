...
//  float32 t_usec = 0.0f;
  ...
  for (int i = 0; i < count; ++i)
  {
    ...
    total_itr_time+= (myworld->GetProfile()).step;
    total_col_up_time+= (myworld->GetProfile()).collide;
    total_pos_up_time+= (myworld->GetProfile()).solvePosition;
    total_vel_up_time+= (myworld->GetProfile()).solveVelocity;
  }
